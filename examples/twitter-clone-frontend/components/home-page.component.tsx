...
import { ResponsiveContainer } from './home-page-responsive.component';
...
export const HomepageLayout = () => (
  <ResponsiveContainer>
    ...
    <Segment style={{ padding: '0em' }} vertical={true}>
      <Grid celled='internally' columns='equal' stackable={true}>
        <Grid.Row textAlign='center'>
          ...
          <Grid.Column style={{ paddingBottom: '5em', paddingTop: '5em' }}>
            ...
            <p style={{ fontSize: '1.33em' }}>
              <Image avatar={true} src='/images/avatar/large/nan.jpg' />
